...
Config.GlobalTax = 5.0 -- The tax, in %, that people will be charged at the pump. (Default: 15% or 15.0)
...
Config.JerryCanPrice = 20000 -- The price of a jerry can, not including tax.
...
Config.FuelReservesPrice = 100 -- This is the price of fuel reserves for gas station owners.
...
Config.MinimumFuelPrice = 100 -- This is the minimum value you want to let players set their fuel prices to.
Config.MaxFuelPrice = 1000 -- This is the maximum value you want to let players set their fuel prices to.
