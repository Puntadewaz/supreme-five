...
Config.CraftingStations = { -- All crafting stations config
    ...
    cafecrafting = {
        ...
        Title = "Cooking Station", -- Crafting station title
        CraftingStationID = "cafecrafting", -- Crafting station id (Must be unique)

        Coords = vector3(-590.92, -1056.49, 22.35), -- Crafting station coords
        ...
        MapBlip = { -- The blip will be disappear in minimap if you keep Config.MapBlipStatus as true
            ...
            Sprite = 402, -- https://docs.fivem.net/docs/game-references/blips/#blips
            Color = 3, -- https://docs.fivem.net/docs/game-references/blips/#blip-colors
            Display = 0, -- 0 = Doesn't show up, ever, anywhere | 2 = Shows on both main map and minimap (Selectable on map) | 3 = Shows on main map only (Selectable on map) | 4 = Shows on main map only (Selectable on map) | 5 = Shows on minimap only | 8 = Shows on both main map and minimap (Not selectable on map)
            Scale = 0.8, -- Blip scale
            Text = "Cooking Station", -- Blip text
            Vector3 = vector3(-590.92, -1056.49, 22.35) -- Crafting station coords

        },

        Target = {

            Vector3 = vector3(-590.92, -1056.49, 22.35),
            Vector3One = 1.65,
            Vector3Two = 2.45,
            Name = "cafecrafting", -- Must be same as CraftingStationID
            Heading = 350,
            MinZ = 24.72,
            MaxZ = 28.72,

            FAIcon = "fa-solid fa-kitchen-set" -- https://fontawesome.com/icons
        ...
        Crafts = {
            ...
            { -- 1
                ...
                Item = "grilledchicken", -- Item ID
                Label = "Ayam Panggang", -- Item's label
                Description = "", -- Item's description
                Category = "cafecrafting", -- Item's category, must be same as CraftingStationID
                Icon = "../../[qb]/qb-inventory/html/images/grilledchicken.png", -- Item's icon

                Quantity = 20, -- Quantity to be given when crafted
                SuccessRate = 100, -- Probability of successful item production ( 90 = %90... )
                ...
                Requirements = {

                    {
                        Label = "Chicken",
                        ItemName = "chicken",
                        Icon = "../../[qb]/qb-inventory/html/images/chicken.png",
                        Amount = 1,
                        RemoveOnCraft = true
                    },
                    {
                        Label = "Salt",
                        ItemName = "salt",
                        Icon = "../../[qb]/qb-inventory/html/images/salt.png",
                        Amount = 2,
                        RemoveOnCraft = true
                    },
                    {
                        Label = "Lemon",
                        ItemName = "lemon",
                        Icon = "../../[qb]/qb-inventory/html/images/lemon.png",
                        Amount = 1,
                        RemoveOnCraft = true
                    },
