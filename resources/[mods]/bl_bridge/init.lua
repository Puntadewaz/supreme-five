...
local DEFAULT_INVENTORY_FRAMEWORK = 'ox'
...
Config = {
    convars = {
        ...
        inventory = format(GetConvar('bl:inventory', DEFAULT_INVENTORY_FRAMEWORK)),
        context = format(GetConvar('bl:context', DEFAULT_FRAMEWORK)),
        target = format(GetConvar('bl:target', DEFAULT_INVENTORY_FRAMEWORK)),
        progressbar = format(GetConvar('bl:progressbar', DEFAULT_INVENTORY_FRAMEWORK)),
        radial = format(GetConvar('bl:radial', DEFAULT_FRAMEWORK)),
        notify = format(GetConvar('bl:notify', DEFAULT_INVENTORY_FRAMEWORK)),
        textui = format(GetConvar('bl:textui', DEFAULT_INVENTORY_FRAMEWORK)),
    },
    resources = {
        inventory = {
            ox = 'ox_inventory',
