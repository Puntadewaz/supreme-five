...
files {
	...
	'common/vehiclelayouts_xp210.meta',
	'common/vehicles.meta',
	'common/xp210contentunlocks.meta',
	'common/*.meta'
}
data_file 'DLCTEXT_FILE' 'common/dlctext.meta'
data_file 'VEHICLE_LAYOUTS_FILE' 'common/vehiclelayouts_xp210.meta'
...
data_file 'CONTENT_UNLOCKING_META_FILE' 'common/xp210contentunlocks.meta'
