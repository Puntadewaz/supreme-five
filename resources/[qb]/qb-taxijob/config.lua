...
Config.Meter = {
    ['defaultPrice'] = 15000.0, -- price per mile
    ['startingPrice'] = 5000     -- static starting price
}

Config.Location = vector3(363.54, -1586.78, 29.29)     -- map blip position
Config.parkLocation = vector3(390.67, -1618.65, 29.29) -- vehicle garage location

Config.Vehicle = {
    vector3(390.67, -1618.65, 29.29)
}

Config.Duty = vector3(357.97, -1591.62, 29.29)

Config.Advanced = {
    Bonus = {
        Enabled = true,
        Percentage = 50,    -- bonus in % for intact vehicle
    },
    Speech = {
        Enabled = true,
