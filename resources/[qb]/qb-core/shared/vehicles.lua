...
local Vehicles = {
    ...
    { model = '765lt',           name = '765',                   brand = 'McLaren',         price = 2845000,  category = 'super',         type = 'automobile', shop = 'luxury' },
    { model = 'razerx3',         name = 'Razer X 3',                     brand = 'Razer',           price = 2845000,  category = 'super',          type = 'automobile', shop = 'luxury' },
    { model = 'bmws19',          name = 'S1000RR 2019',              brand = 'BMW',             price = 2845000,  category = 'super',          type = 'automobile', shop = 'luxury' },
    { model = 'r820',            name = 'R8',                       brand = 'Audi',            price = 2845000,  category = 'super',          type = 'automobile', shop = 'luxury' },
    { model = 'skyline',      name = 'Skyline GTR',            brand = 'Nissan',          price = 2845000,  category = 'super',          type = 'automobile', shop = 'luxury' },
    { model = 'benze55',      name = 'E55 AMG',            brand = 'Mercedes-Benz',          price = 2845000,  category = 'super',          type = 'automobile', shop = 'luxury' },
    { model = 'bolide',      name = 'Bolide',            brand = 'Bugati',          price = 2845000,  category = 'super',          type = 'automobile', shop = 'luxury' },
    { model = 'casup',      name = 'Supra MK IV',            brand = 'Toyota',          price = 2845000,  category = 'super',          type = 'automobile', shop = 'luxury' },
    { model = 'topfoil',      name = 'Lancer EVO IX',            brand = 'Mitshubishi',          price = 2845000,  category = 'super',          type = 'automobile', shop = 'luxury' },
    ...
    { model = 'Globbing Mode',      name = 'Ambulance',            brand = 'Ford',          price = 2845000,  category = 'super',          type = 'automobile', shop = 'luxury' },
    --- Motorcycles (8)
