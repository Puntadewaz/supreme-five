...
local Vehicles = {
    ...
    { model = 'fordvoodoo',        name = 'Ford Mustang',           brand = 'Willard',         price = 35000,   category = 'muscle',         type = 'automobile', shop = 'pdm' },
    ...
    --- Limited (12)
    { model = '765lt',           name = 'McLaren 765',                   brand = 'McLaren',         price = 2845000,  category = 'limited',         type = 'automobile', shop = 'none' },
    { model = 'razerx3',         name = 'Razer X 3',                     brand = 'Razer',           price = 2845000,  category = 'limited',          type = 'automobile', shop = 'none' },
    { model = 'bmws19',          name = 'S1000RR 2019',              brand = 'BMW',             price = 2845000,  category = 'limited',          type = 'automobile', shop = 'none' },
    { model = 'r820',            name = 'R8',                       brand = 'Audi',            price = 2845000,  category = 'limited',          type = 'automobile', shop = 'luxury' },
    { model = 'skyline',      name = 'Skyline GTR',            brand = 'Nissan',          price = 2845000,  category = 'limited',          type = 'automobile', shop = 'luxury' },
    { model = 'benze55',      name = 'E55 AMG',            brand = 'Mercedes-Benz',          price = 2845000,  category = 'limited',          type = 'automobile', shop = 'none' },
    { model = 'bolide',      name = 'Bolide',            brand = 'Bugati',          price = 2845000,  category = 'limited',          type = 'automobile', shop = 'none' },
    { model = 'casup',      name = 'Supra MK IV',            brand = 'Toyota',          price = 2845000,  category = 'limited',          type = 'automobile', shop = 'luxury' },
    { model = 'topfoil',      name = 'Lancer EVO IX',            brand = 'Mitshubishi',          price = 2845000,  category = 'limited',          type = 'automobile', shop = 'luxury' },
    -- { model = 'vsgran',      name = 'Vsgran',            brand = 'Vsgran',          price = 2845000,  category = 'limited',          type = 'automobile', shop = '' },
    { model = 'redeye',      name = 'Challenger',            brand = 'Dodge',          price = 2845000,  category = 'limited',          type = 'automobile', shop = 'luxury' },
    -- { model = 'fordvoodoo',      name = 'Fordvoodoo',            brand = 'Fordvoodoo',          price = 2845000,  category = 'super',          type = 'automobile', shop = '' },
    { model = 'chiron',      name = 'Chiron',            brand = 'Buggati',          price = 2845000,  category = 'limited',          type = 'automobile', shop = 'none' },
    { model = '19Raptor',      name = 'Raptor',            brand = 'Ford',          price = 2845000,  category = 'limited',          type = 'automobile', shop = 'none' },
    { model = 'bmwm8',      name = 'M8 Coupe',            brand = 'BMW',          price = 2845000,  category = 'limited',          type = 'automobile', shop = 'none' },
    { model = 'urusperf23',      name = 'Urus',            brand = 'Lamborghini',          price = 2845000,  category = 'limited',          type = 'automobile', shop = 'luxury' },
    { model = 'huayrar',      name = 'Huayra',            brand = 'Pagani',          price = 2845000,  category = 'limited',          type = 'automobile', shop = 'none' },
    { model = 'nkscout',      name = 'Ambulance',            brand = 'Ford',          price = 2845000,  category = 'limited',          type = 'automobile', shop = 'none' },
    { model = 'bmwems',      name = 'Ambulance2',            brand = 'BMW',          price = 2845000,  category = 'limited',          type = 'automobile', shop = 'none' },
    { model = 'mclarenf1',      name = 'McLaren F1',            brand = 'McLaren',          price = 2845000,  category = 'limited',          type = 'automobile', shop = 'none' },
    ...
    { model = 'cayman16',        name = 'Cayman',                     brand = 'Porche',         price = 50000,   category = 'limited',    type = 'car',       shop = 'none' },
    --- Electric
    ...
    --- PDM ONLY
    { model = 'manchez2',        name = 'Manchez Scout',                 brand = 'Maibatsu',        price = 14000,   category = 'PDM ONLY',    type = 'bike',       shop = 'pdm' },
    { model = 'aeroxark',        name = 'AEROX 155',                     brand = 'YAMAHA',         price = 11500000,   category = 'PDM ONLY',    type = 'bike',       shop = 'pdm' },
    { model = 'allnewnmax',        name = 'NMAX 155',                     brand = 'YAMAHA',         price = 12500000,   category = 'PDM ONLY',    type = 'bike',       shop = 'pdm' },
    { model = 'mt125',        name = 'MT 150',                     brand = 'YAMAHA',         price = 16000000,   category = 'PDM ONLY',    type = 'bike',       shop = 'pdm' },
    { model = 'adv1502023',        name = 'ADV 150',                     brand = 'HONDA',         price = 12500000,   category = 'PDM ONLY',    type = 'bike',       shop = 'pdm' },
    { model = 'PCX160',        name = 'PCX 160',                     brand = 'HONDA',         price = 10000000,   category = 'PDM ONLY',    type = 'bike',       shop = 'pdm' },
    { model = 'swift2021',          name = 'Swift',                        brand = 'Suzuki',            price = 20000000,  category = 'PDM ONLY',          type = 'automobile', shop = 'pdm' },
    { model = 'xp210',          name = 'GR Yaris',                        brand = 'Toyota',            price = 22000000,  category = 'PDM ONLY',          type = 'automobile', shop = 'pdm' },
    { model = 'corollacross20',          name = 'Corolla Cross',                        brand = 'Toyota',            price = 22000000,  category = 'PDM ONLY',          type = 'automobile', shop = 'pdm' },
    { model = 'elantrang',          name = 'Elantra',                        brand = 'Hyundai',            price = 25000000,  category = 'PDM ONLY',          type = 'automobile', shop = 'pdm' },
    { model = 'sonata20',          name = 'Sonata',                        brand = 'Hyundai',            price = 25000000,  category = 'PDM ONLY',          type = 'automobile', shop = 'pdm' },
    ...
    { model = 'ocni422spe',      name = 'BMWi4',            brand = 'BMW',          price = 2845000,  category = 'service',          type = 'automobile', shop = 'none' },
    --- Emergency (18)
