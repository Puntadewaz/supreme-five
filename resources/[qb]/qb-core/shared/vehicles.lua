...
local Vehicles = {
    ...
    --- Limited (12)
    { model = '765lt',           name = '765',                   brand = 'McLaren',         price = 2845000,  category = 'limited',         type = 'automobile', shop = '' },
    { model = 'razerx3',         name = 'Razer X 3',                     brand = 'Razer',           price = 2845000,  category = 'limited',          type = 'automobile', shop = '' },
    { model = 'bmws19',          name = 'S1000RR 2019',              brand = 'BMW',             price = 2845000,  category = 'limited',          type = 'automobile', shop = '' },
    { model = 'r820',            name = 'R8',                       brand = 'Audi',            price = 2845000,  category = 'limited',          type = 'automobile', shop = '' },
    { model = 'skyline',      name = 'Skyline GTR',            brand = 'Nissan',          price = 2845000,  category = 'limited',          type = 'automobile', shop = '' },
    { model = 'benze55',      name = 'E55 AMG',            brand = 'Mercedes-Benz',          price = 2845000,  category = 'limited',          type = 'automobile', shop = '' },
    { model = 'bolide',      name = 'Bolide',            brand = 'Bugati',          price = 2845000,  category = 'limited',          type = 'automobile', shop = '' },
    { model = 'casup',      name = 'Supra MK IV',            brand = 'Toyota',          price = 2845000,  category = 'limited',          type = 'automobile', shop = '' },
    { model = 'topfoil',      name = 'Lancer EVO IX',            brand = 'Mitshubishi',          price = 2845000,  category = 'limited',          type = 'automobile', shop = '' },
    -- { model = 'vsgran',      name = 'Vsgran',            brand = 'Vsgran',          price = 2845000,  category = 'limited',          type = 'automobile', shop = '' },
    { model = 'redeye',      name = 'Challenger',            brand = 'Dodge',          price = 2845000,  category = 'limited',          type = 'automobile', shop = '' },
    -- { model = 'fordvoodoo',      name = 'Fordvoodoo',            brand = 'Fordvoodoo',          price = 2845000,  category = 'super',          type = 'automobile', shop = '' },
    { model = 'chiron',      name = 'Chiron',            brand = 'Buggati',          price = 2845000,  category = 'limited',          type = 'automobile', shop = '' },
    { model = '19Raptor',      name = 'Raptor',            brand = 'Ford',          price = 2845000,  category = 'limited',          type = 'automobile', shop = '' },
    { model = 'bmwm8',      name = 'M8 Coupe',            brand = 'BMW',          price = 2845000,  category = 'limited',          type = 'automobile', shop = '' },
    { model = 'urusperf23',      name = 'Urus',            brand = 'Lamborghini',          price = 2845000,  category = 'limited',          type = 'automobile', shop = '' },
    { model = 'huayrar',      name = 'Huayra',            brand = 'Pagani',          price = 2845000,  category = 'limited',          type = 'automobile', shop = '' },
    { model = 'nkscout',      name = 'Ambulance',            brand = 'Ford',          price = 2845000,  category = 'limited',          type = 'automobile', shop = '' },
    { model = 'bmwems',      name = 'Ambulance2',            brand = 'bmw',          price = 2845000,  category = 'limited',          type = 'automobile', shop = '' },
    { model = 'mclarenf1',      name = 'mclarenf1',            brand = 'mclaren',          price = 2845000,  category = 'limited',          type = 'automobile', shop = '' },
    { model = 'fdnyambo',      name = 'EMS',            brand = 'AMBULU',          price = 2845000,  category = 'limited',          type = 'automobile', shop = '' },
    { model = 'wraith',      name = 'RR WRAITH',            brand = 'RR',          price = 2845000,  category = 'limited',          type = 'automobile', shop = '' },
    { model = 'ocni422spe',      name = 'BMWi4',            brand = 'BMW',          price = 2845000,  category = 'limited',          type = 'automobile', shop = '' },
    { model = 'ocnlamtmc',      name = 'Terzo',            brand = 'Lamborghini',          price = 2845000,  category = 'limited',          type = 'automobile', shop = '' },
    { model = 'R1Yamaha',        name = 'Yamaha R1',                     brand = 'Yamaha',         price = 50000,   category = 'limited',    type = 'bike',       shop = '' },
    { model = 'yzfr6',        name = 'Yamaha R6',                     brand = 'Yamaha',         price = 50000,   category = 'limited',    type = 'bike',       shop = '' },
    { model = 'CBR1000RRR',        name = 'CBR FIREBLADE',                     brand = 'HONDA',         price = 50000,   category = 'limited',    type = 'bike',       shop = '' },
    --- Motorcycles (8)
