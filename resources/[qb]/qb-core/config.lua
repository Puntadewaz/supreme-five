...
QBConfig.DefaultSpawn = vector4(26.64, 7303.52, 4.4, 198.29)
...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { cash = 100000, bank = 10000, crypto = 0 } -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
...
QBConfig.Player = {}
QBConfig.Player.HungerRate = 4 -- Rate at which hunger goes down.
QBConfig.Player.ThirstRate = 4 -- Rate at which thirst goes down.
...
QBConfig.Server.Discord = 'https://discord.gg/FdxeWT47R3'                            -- Discord invite link
