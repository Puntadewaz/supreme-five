...
Config.Locations = {
    ['Innocence'] = {
        settings = {
            label = 'Mechanic EterLife',
            welcomeLabel = "Welcome to Mechanic EterLife!",
            enabled = false,
        },
        blip = {
            label = 'Start Custom',
        ...
        restrictions = { 
            job = { 'mechanic' },
            deniedClasses = { 18, 17, 19, 20, 21 } 
        },
        zones = {
            { coords = vector3(-191.96, -1315.08, 30.89), length = 6.0, width = 4.0, heading = 270.0, minZ = 29.88, maxZ = 33.48 },
            { coords = vector3(-192.48, -1323.06, 30.91), length = 6.0, width = 4.0, heading = 270.0, minZ = 29.88, maxZ = 33.48 },
            { coords = vector3(-212.37, -1331.19, 30.89), length = 6.0, width = 4.0, heading = 270.0, minZ = 29.88, maxZ = 33.48 },
            { coords = vector3(-239.56, -1318.3, 30.89), length = 6.0, width = 4.0, heading = 270.0, minZ = 29.88, maxZ = 33.48 },
            { coords = vector3(-232.62, -1318.13, 30.89), length = 6.0, width = 4.0, heading = 270.0, minZ = 29.88, maxZ = 33.48 },
        }
    },
