...
-- RegisterNetEvent('cafe:client:SendBillEmail', function(amount, hospitalName)
...
-- RegisterNetEvent('qb-cafejob:checkin', function()
--     local coords = GetEntityCoords(PlayerPedId())
--     for i = 1, #Config.Locations['cafe'] do
...
-- RegisterNetEvent('qb-cafejob:beds', function(hospitalIndex, bedId)
--     if bedId then
...
--         for cafeKey = 1, #Config.Locations['hospital'] do
--             for bedKey = 1, #Config.Locations['hospital'][cafeKey]['beds'] do
--                 local v = Config.Locations['hospital'][cafeKey]['beds'][bedKey]
--                 exports['qb-target']:AddBoxZone('beds' .. bedKey, v.coords, 2.5, 2.3, {
--                     name = 'beds' .. bedKey .. Config.Locations['hospital'][cafeKey]['name'],
--                     heading = -20,
--                     debugPoly = false,
--                     minZ = v.coords.z - 1,
--                     maxZ = v.coords.z + 1,
