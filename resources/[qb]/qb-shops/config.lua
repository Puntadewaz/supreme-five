...
Config.Products = {
    ...
    ['hardware'] = {
        ...
        -- { name = 'repairkit',         price = 250, amount = 50, requiredJob = { 'mechanic' } },
    ...
    ['weapons'] = {
        { name = 'weapon_knife',         price = 250,  amount = 250, requiredLicense = 'weapon' },
        { name = 'weapon_bat',           price = 250,  amount = 250, requiredLicense = 'weapon' },
        { name = 'weapon_hatchet',       price = 250,  amount = 250, requiredLicense = 'weapon' },
    ...
    ['prison'] = {
        { name = 'sandwich',     price = 500, amount = 1 },
        { name = 'water_bottle', price = 500, amount = 1 },
    },
    ['police'] = {
        { name = 'weapon_pistol',       price = 0, amount = 1, info = { attachments = { { component = 'COMPONENT_AT_PI_FLSH', label = 'Flashlight' } } } },
        { name = 'weapon_stungun',      price = 0, amount = 1, info = { attachments = { { component = 'COMPONENT_AT_AR_FLSH', label = 'Flashlight' } } } },
        { name = 'weapon_pumpshotgun',  price = 0, amount = 1, info = { attachments = { { component = 'COMPONENT_AT_AR_FLSH', label = 'Flashlight' } } } },
        { name = 'weapon_smg',          price = 0, amount = 1, info = { attachments = { { component = 'COMPONENT_AT_SCOPE_MACRO_02', label = '1x Scope' }, { component = 'COMPONENT_AT_AR_FLSH', label = 'Flashlight' } } } },
        { name = 'weapon_carbinerifle', price = 0, amount = 1, info = { attachments = { { component = 'COMPONENT_AT_AR_FLSH', label = 'Flashlight' }, { component = 'COMPONENT_AT_SCOPE_MEDIUM', label = '3x Scope' } } } },
        { name = 'weapon_nightstick',   price = 0, amount = 1 },
        { name = 'weapon_flashlight',   price = 0, amount = 1 },
        { name = 'pistol_ammo',         price = 0, amount = 1 },
        { name = 'smg_ammo',            price = 0, amount = 1 },
        { name = 'shotgun_ammo',        price = 0, amount = 1 },
        { name = 'rifle_ammo',          price = 0, amount = 1 },
        { name = 'handcuffs',           price = 0, amount = 1 },
        { name = 'empty_evidence_bag',  price = 0, amount = 1 },
        { name = 'police_stormram',     price = 0, amount = 1 },
    ...
    ['ambulance'] = {
        -- { name = 'radio',                   price = 0, amount = 50 },
        { name = 'bandage',                 price = 150, amount = 1 },
        { name = 'painkillers',             price = 150, amount = 1 },
        { name = 'firstaid',                price = 150, amount = 1 },
        -- { name = 'weapon_flashlight',       price = 0, amount = 50 },
        -- { name = 'weapon_fireextinguisher', price = 0, amount = 50 },
    },
    ['mechanic'] = {
        { name = 'veh_toolbox',       price = 150, amount = 1, requiredJob = 'mechanic' },
        { name = 'veh_armor',         price = 150, amount = 1, requiredJob = 'mechanic' },
        { name = 'veh_brakes',        price = 150, amount = 1, requiredJob = 'mechanic' },
        { name = 'veh_engine',        price = 150, amount = 1, requiredJob = 'mechanic' },
        { name = 'veh_suspension',    price = 150, amount = 1, requiredJob = 'mechanic' },
        { name = 'veh_transmission',  price = 150, amount = 1, requiredJob = 'mechanic' },
        { name = 'veh_turbo',         price = 150, amount = 1, requiredJob = 'mechanic' },
        { name = 'veh_interior',      price = 150, amount = 1, requiredJob = 'mechanic' },
        { name = 'veh_exterior',      price = 150, amount = 1, requiredJob = 'mechanic' },
        { name = 'veh_wheels',        price = 150, amount = 1, requiredJob = 'mechanic' },
        { name = 'veh_neons',         price = 150, amount = 1, requiredJob = 'mechanic' },
        { name = 'veh_xenons',        price = 150, amount = 1, requiredJob = 'mechanic' },
        { name = 'veh_tint',          price = 150, amount = 1, requiredJob = 'mechanic' },
        { name = 'veh_plates',        price = 150, amount = 1, requiredJob = 'mechanic' },
        -- { name = 'nitrous',           price = 5000, amount = 50 },
        { name = 'tunerlaptop',       price = 150, amount = 1, requiredJob = 'mechanic' },
        -- { name = 'repairkit',         price = 5000, amount = 50 },
        { name = 'advancedrepairkit', price = 150, amount = 1, requiredJob = 'mechanic' },
        { name = 'tirerepairkit',     price = 150, amount = 1, requiredJob = 'mechanic' },
    }
}
