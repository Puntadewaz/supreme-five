...
Config.Products = {
    ...
    ['mechanic'] = {
        { name = 'veh_toolbox',       price = 5000, amount = 1 },
        { name = 'veh_armor',         price = 5000, amount = 1 },
        { name = 'veh_brakes',        price = 5000, amount = 1 },
        { name = 'veh_engine',        price = 5000, amount = 1 },
        { name = 'veh_suspension',    price = 5000, amount = 1 },
        { name = 'veh_transmission',  price = 5000, amount = 1 },
        { name = 'veh_turbo',         price = 5000, amount = 1 },
        { name = 'veh_interior',      price = 5000, amount = 1 },
        { name = 'veh_exterior',      price = 5000, amount = 1 },
        { name = 'veh_wheels',        price = 5000, amount = 1 },
        { name = 'veh_neons',         price = 5000, amount = 1 },
        { name = 'veh_xenons',        price = 5000, amount = 1 },
        { name = 'veh_tint',          price = 5000, amount = 1 },
        { name = 'veh_plates',        price = 5000, amount = 1 },
        -- { name = 'nitrous',           price = 5000, amount = 50 },
        -- { name = 'tunerlaptop',       price = 5000, amount = 50 },
        -- { name = 'repairkit',         price = 5000, amount = 50 },
        { name = 'advancedrepairkit', price = 5000, amount = 1 },
        { name = 'tirerepairkit',     price = 5000, amount = 1 },
    }
}
