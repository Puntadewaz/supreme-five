...
Config.Products = {
    ...
    ['mechanic'] = {
        { name = 'veh_toolbox',       price = 0, amount = 999999 },
        { name = 'veh_armor',         price = 0, amount = 999999 },
        { name = 'veh_brakes',        price = 0, amount = 999999 },
        { name = 'veh_engine',        price = 0, amount = 999999 },
        { name = 'veh_suspension',    price = 0, amount = 999999 },
        { name = 'veh_transmission',  price = 0, amount = 999999 },
        { name = 'veh_turbo',         price = 0, amount = 999999 },
        { name = 'veh_interior',      price = 0, amount = 999999 },
        { name = 'veh_exterior',      price = 0, amount = 999999 },
        { name = 'veh_wheels',        price = 0, amount = 999999 },
        { name = 'veh_neons',         price = 0, amount = 999999 },
        { name = 'veh_xenons',        price = 0, amount = 999999 },
        { name = 'veh_tint',          price = 0, amount = 999999 },
        { name = 'veh_plates',        price = 0, amount = 999999 },
        -- { name = 'nitrous',           price = 5000, amount = 50 },
        -- { name = 'tunerlaptop',       price = 5000, amount = 50 },
        -- { name = 'repairkit',         price = 5000, amount = 50 },
        { name = 'advancedrepairkit', price = 0, amount = 999999 },
        { name = 'tirerepairkit',     price = 0, amount = 999999 },
    }
}
