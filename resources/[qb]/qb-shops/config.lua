...
Config.Products = {
    ...
    ['hardware'] = {
        ...
        { name = 'phone',             price = 85000, amount = 50 },
        { name = 'radio',             price = 25000, amount = 50 },
        ...
        { name = 'cleaningkit',       price = 15000, amount = 150 },
    ...
    ['mechanic'] = {
        { name = 'veh_toolbox',       price = 150, amount = 1 },
        { name = 'veh_armor',         price = 150, amount = 1 },
        { name = 'veh_brakes',        price = 150, amount = 1 },
        { name = 'veh_engine',        price = 150, amount = 1 },
        { name = 'veh_suspension',    price = 150, amount = 1 },
        { name = 'veh_transmission',  price = 150, amount = 1 },
        { name = 'veh_turbo',         price = 150, amount = 1 },
        { name = 'veh_interior',      price = 150, amount = 1 },
        { name = 'veh_exterior',      price = 150, amount = 1 },
        { name = 'veh_wheels',        price = 150, amount = 1 },
        { name = 'veh_neons',         price = 150, amount = 1 },
        { name = 'veh_xenons',        price = 150, amount = 1 },
        { name = 'veh_tint',          price = 150, amount = 1 },
        { name = 'veh_plates',        price = 150, amount = 1 },
